...
class VerilogListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by VerilogParser#range_definition.
    def enterRange_definition(self, ctx:VerilogParser.Range_definitionContext):
        pass

    # Exit a parse tree produced by VerilogParser#range_definition.
    def exitRange_definition(self, ctx:VerilogParser.Range_definitionContext):
        pass
